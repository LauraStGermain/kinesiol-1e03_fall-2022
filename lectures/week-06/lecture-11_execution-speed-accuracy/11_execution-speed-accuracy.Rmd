...
date: "Fall 2022 Week 6 </br> Lecture 11"
output:
...
# Review and finishing up last lecture
...
1. How would movement times compare for tasks with:  

    a) Amplitude = 2 cm | Target width = 2 cm (ID = 1 bit)  
    b) Amplitude = 2 cm | Target width = 1 cm (ID = 2 bits)  
    
2. How would movement times compare for tasks with:  

    a) Amplitude = 4 cm | Target width = 1 cm (ID = 3 bit)  
    b) Amplitude = 8 cm | Target width = 2 cm (ID = 3 bits)  
...
Have a discussion with those around you to come up with other real-world examples of a speed-accuracy trade off
