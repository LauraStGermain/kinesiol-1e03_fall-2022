...
date: "Fall 2022 Week 0 </br> Lecture 1"
output:
...
2. Identify and describe **four influences** on how we perform a motor skill.
...
.black[MOTOR SKILLS]: Depend on an individual's **quality of movement**
...
Defined as activities or tasks that require **voluntary control** over movement of the joints and body segments to **achieve a goal**

.center[
![](imgs/motor-skills.png)
]
...
## The relationships between motor skills and movements

- **Many-to-one** relationship
    - There are a variety of movements that can accomplish the same action goal

- **One-to-many** relationship
    - One movement pattern could be used to achieve many different action goals
