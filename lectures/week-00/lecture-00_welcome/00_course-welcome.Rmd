...
- Explain the distinction between behaviour that is goal-directed and behaviour that is not goal-directed.

- Identify and describe different taxonomies used to classify motor skills.

- List, explain, and calculate common variables used to measure motor performance.

- Describe sensory systems that support human motor behaviour.

- Compare and constrast different classes of control.

- Describe processes underlying motor preparation and factors that inﬂuence preparation.

- Describe and explain the interaction between attention and motor performance.

- Describe the relationship between speed and accuracy in aiming tasks.
...
- Identify and describe different methods to assess motor skill learning.

- Compare and contrast different models of skill acquisition.

- Identify, describe, and compare different conditions of practice for learning.

- Explain why some conditions of practice are more effective than other conditions.

- Interpret, summarize, and discuss data from common tasks used in the study of motor control and learning.

- Deﬁne metascience and discuss its relevance to motor learning and control research.
...
- Differentiate scientiﬁc and non-scientiﬁc sources of information.

- Develop effective strategies to work independently and collaboratively in small teams.

- Successfully navigate unforeseen challenges as they arise through collaborative problem-solving.

- Disseminate scientiﬁc information and share own ideas through written and oral communication.

- Apply effective time management techniques to deliver required products on time.
